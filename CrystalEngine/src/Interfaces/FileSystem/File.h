...
namespace crystal
{
	...
	public:
		...
		static void WriteAllLines(const path_type& path, const std::vector<std::string>& text);
		...
		static void Replace(const path_type& srcFile, const path_type& destFile,
			const path_type& backupFile);
