...
namespace crystal
{
    ...
    Spectrum DiffusedAreaLight::Sample_Li(const InteractionGeometryInfo& surface_w,
    ...
    float DiffusedAreaLight::Pdf_Li(const InteractionGeometryInfo& surface_w, const Vector3f& wi) const
    {
        return m_areaSampler->PdfLight(surface_w, wi);
    }

    Spectrum DiffusedAreaLight::Eval_Le(const InteractionGeometryInfo& surface, const Vector3f & wi) const
    {
