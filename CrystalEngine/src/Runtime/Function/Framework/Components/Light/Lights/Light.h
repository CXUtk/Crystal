...
namespace crystal
{
    ...
    public:
        ...
        virtual Spectrum Sample_Li(const SurfaceGeometryInfo& surface_w, const Vector2f& sample,
            Point3f* endpoint, float* pdf) const = 0;

        virtual float Pdf_Li(const SurfaceGeometryInfo& surface_w, const Vector3f& wi) const = 0;
